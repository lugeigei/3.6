...
class ControlPanel:
    ...
    def verify_password(self):
        if self.system.hardware.system_locked:
            messagebox.showwarning("xitong suo ding", "qing dengdai 3 fenzhong")
            return
        ...
        if self.input_buffer == self.password:
            ...
            with self.system.hardware.lock:
                ...
                if self.system.hardware.auth_attempts['password'] >=3:
                    ...
                    messagebox.showwarning("xitong suo ding", "xi tong jiang suo ding 3 fenzhong")
...
#             self.pwd_display.config(text="")
    ...
    def _update_lock_status(self):
        if self.system.hardware.system_locked:
            remaining = 180 - (time.time() - self.system.hardware.lock_time)
